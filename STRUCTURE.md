...
### Datos
- **`data.js`** - Datos de productos, galería comunitaria y colaboraciones
...
- **`brand.html`** - Página dinámica de cada colaboración, con información, links, contacto y galería fullscreen
